...
BUILTIN(builtin_ncmenu_item_count)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(item_count(menu));
}
...
BUILTIN(builtin_ncmenu_item_index)
{
  ...
  ld_item = eval(FIRST_ARG, env);
  item = (ITEM *)get_special(ld_item, sym_ncmenu_item);
  return make_number_from_long_long(item_index(item));
}
...
BUILTIN(builtin_ncmenu_item_opts)
{
  ...
  ld_item = eval(FIRST_ARG, env);
  item = (ITEM *)get_special(ld_item, sym_ncmenu_item);
  return make_number_from_long_long(item_opts(item));
}
...
BUILTIN(builtin_ncmenu_item_off)
{
  ...
  return make_number_from_long_long(item_opts_off(item, opts));
}
...
BUILTIN(builtin_ncmenu_item_on)
{
  ...
  item = (ITEM *)get_special(ld_item, sym_ncmenu_item);
  opts = GETINTFROMMPQ(ld_opts);
  return make_number_from_long_long(item_opts_on(item, opts));
}
...
BUILTIN(builtin_ncmenu_menu_back)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(menu_back(menu));
}
...
BUILTIN(builtin_ncmenu_menu_driver)
{
  ...
  return make_number_from_long_long(menu_driver(menu, c));
}
...
BUILTIN(builtin_ncmenu_menu_fore)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(menu_fore(menu));
}
...
BUILTIN(builtin_ncmenu_menu_grey)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(menu_grey(menu));
}
...
BUILTIN(builtin_ncmenu_menu_pad)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(menu_pad(menu));
}
...
BUILTIN(builtin_ncmenu_post_menu)
{
  ...
  ld_menu = eval(FIRST_ARG, env);
  menu = (MENU *)get_special(ld_menu, sym_ncmenu_menu);
  return make_number_from_long_long(post_menu(menu));
}
...
BUILTIN(builtin_ncmenu_set_item_opts)
{
  ...
  item = (ITEM *)get_special(ld_item, sym_ncmenu_item);
  opts = GETINTFROMMPQ(ld_opts);
  return make_number_from_long_long(set_item_opts(item, opts));
}
...
BUILTIN(builtin_ncmenu_set_item_value)
{
  ...
  return make_number_from_long_long(set_item_value(item, value));
}
       /* set_menu_back          attributes(3MENU) */
BUILTIN(builtin_ncmenu_set_menu_back)
{
  ...
  return make_number_from_long_long(set_menu_back(menu, back));
}
...
BUILTIN(builtin_ncmenu_set_menu_fore)
{
  ...
  return make_number_from_long_long(set_menu_fore(menu, fore));
}
...
BUILTIN(builtin_ncmenu_set_menu_grey)
{
  ...
  return make_number_from_long_long(set_menu_grey(menu, grey));
}
...
BUILTIN(builtin_ncmenu_set_menu_items)
{
  ...
  return make_number_from_long_long(set_menu_items(menu, items));
  GC_register_finalizer(ld_result, (GC_finalization_proc)limo_free_menu, menu, NULL, NULL);
  return ld_result;
}
...
BUILTIN(builtin_ncmenu_set_menu_pad)
{
  ...
  return make_number_from_long_long(set_menu_pad(menu, pad));
}
...
void limo_init_ncmenu(limo_data *env)
{
  ...
  // Options
  setq(limo_ncmenu_env, make_sym("O_SELECTABLE"), make_number_from_long_long(O_SELECTABLE));
  setq(limo_ncmenu_env, make_sym("O_ONEVALUE"), make_number_from_long_long(O_ONEVALUE));

  setq(limo_ncmenu_env, make_sym("REQ_LEFT_ITEM"), make_number_from_long_long(REQ_LEFT_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_RIGHT_ITEM"), make_number_from_long_long(REQ_RIGHT_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_UP_ITEM"), make_number_from_long_long(REQ_UP_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_DOWN_ITEM"), make_number_from_long_long(REQ_DOWN_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_SCR_ULINE"), make_number_from_long_long(REQ_SCR_ULINE));
  setq(limo_ncmenu_env, make_sym("REQ_SCR_DLINE"), make_number_from_long_long(REQ_SCR_DLINE));
  setq(limo_ncmenu_env, make_sym("REQ_SCR_DPAGE"), make_number_from_long_long(REQ_SCR_DPAGE));
  setq(limo_ncmenu_env, make_sym("REQ_SCR_UPAGE"), make_number_from_long_long(REQ_SCR_UPAGE));
  setq(limo_ncmenu_env, make_sym("REQ_FIRST_ITEM"), make_number_from_long_long(REQ_FIRST_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_LAST_ITEM"), make_number_from_long_long(REQ_LAST_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_NEXT_ITEM"), make_number_from_long_long(REQ_NEXT_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_PREV_ITEM"), make_number_from_long_long(REQ_PREV_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_TOGGLE_ITEM"), make_number_from_long_long(REQ_TOGGLE_ITEM));
  setq(limo_ncmenu_env, make_sym("REQ_CLEAR_PATTERN"), make_number_from_long_long(REQ_CLEAR_PATTERN));
  setq(limo_ncmenu_env, make_sym("REQ_BACK_PATTERN"), make_number_from_long_long(REQ_BACK_PATTERN));
  setq(limo_ncmenu_env, make_sym("REQ_NEXT_MATCH"), make_number_from_long_long(REQ_NEXT_MATCH));
  setq(limo_ncmenu_env, make_sym("REQ_PREV_MATCH"), make_number_from_long_long(REQ_PREV_MATCH));
